...
local function CreateSummaryHeaderFrame(parentFrame)
    ...
    playerName.playerText = CustomFontString(16, textColor, playerName, "OUTLINE")
    ...
    scoreHeader.ratingText = CustomFontString(16, textColor, scoreHeader, "OUTLINE")
    scoreHeader.ratingText:SetPoint("TOP", scoreHeader, "TOP")
    scoreHeader.ratingText:SetText("0.0")
    scoreHeader.gainText = CustomFontString(10, textColor, scoreHeader, "OUTLINE")
...
local function CreateAffixInfoFrame(anchorFrame, parentFrame)
    ...
    frame.descFrame.descText = CustomFontString(12, textColor, frame.descFrame, nil)
...
local function CreateRunFrame(anchorFrame, parentFrame, affix)
    ...
    affixFrame.keyLevelText = CustomFontString(12, textColor, affixFrame, nil)
...
local function CreateDungeonScoreFrame(anchorFrame, parentFrame)
    ...
    scoreFrame.scoreText = CustomFontString(12, textColor, scoreFrame, nil)
...
local function CreateDungeonSummaryHeader(parentFrame)
    ...
    scoreHeader.text = CustomFontString(12, textColor, scoreHeader, "OUTLINE")
    ...
    dungeonHeader.text = CustomFontString(12, textColor, dungeonHeader, "OUTLINE")
...
local function CreateBugReportFrame(anchorFrame, parentFrame)
    ...
    -- Header
    frame.headerText = CustomFontString(16, textColor, frame, nil)
    ...
    -- Copy url text
    frame.copyText = CustomFontString(12, textColor, frame, nil)
...
local function CreateFooter(anchorFrame, parentFrame, headerFrame)
    ...
    frame.versionText = CustomFontString(10, textColor, frame, nil)
    ...
    bugButton.text = CustomFontString(10, textColor, bugButton, nil)
